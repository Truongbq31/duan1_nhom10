...
$_SESSION['ten_phim'] = $_GET['ten_phim'];
$_SESSION['gio_bat_dau'] = $_GET['gio_bat_dau'];
        ...
        <form action="vnpay_create_payment.php" id="create_form" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="amount"
                       name="amount" type="number" value="<?php echo $_SESSION['gia'];?>"/>
            </div>
            <div class="form-group">
                <label for="order_desc">Nội dung thanh toán</label>
                <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">Thanh toán vé xem phim</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="txt_billing_film"
                       name="txt_billing_email" type="text" value="<?= $_SESSION['ten_phim']?>"/>
            </div>

            <div class="form-group">
                <label >Giờ bắt đầu</label>
                <input class="form-control" id="txt_billing_time"
                       name="txt_billing_email" type="text" value="<?= $_SESSION['gio_bat_dau']?>"/>
            </div>

            <div class="form-group">
                <label >Ngày chiếu</label>
                <input class="form-control" id="txt_billing_day"
                       name="txt_billing_email" type="text" value="<?= $_SESSION['ngay_chieu']?>"/>
            </div>

            <div class="form-group">
                <label >Phòng chiếu</label>
                <input class="form-control" id="txt_billing_room"
                       name="txt_billing_email" type="text" value="<?= $_SESSION['phong_chieu']?>"/>
            </div>

            <div class="form-group">
                <label >Ghế ngồi</label>
                <input class="form-control" id="txt_billing_seat"
                       name="txt_billing_email" type="text" value="<?= $_SESSION['id']?>"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="txt_bill_city"
                       name="txt_bill_city" type="text" value="<?= $_SESSION['chi_nhanh']?>"/>
            </div>
