<?php include("controllers/c_home.php") ?>
<body class="body">
		...
		<div class="row">
			...
			<div class="col-6 col-sm-4 col-lg-2">
				<a href="#" class="partner">
					<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/partners/themeforest-light-background.png" alt="" class="partner__img">
				</a>
			</div>
			<!-- end partner -->
			...
			<div class="col-6 col-sm-4 col-lg-2">
				<a href="#" class="partner">
					<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/partners/audiojungle-light-background.png" alt="" class="partner__img">
				</a>
			</div>
			<!-- end partner -->
			...
			<div class="col-6 col-sm-4 col-lg-2">
				<a href="#" class="partner">
					<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/partners/codecanyon-light-background.png" alt="" class="partner__img">
				</a>
			</div>
			<!-- end partner -->
			...
			<div class="col-6 col-sm-4 col-lg-2">
				<a href="#" class="partner">
					<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/partners/photodune-light-background.png" alt="" class="partner__img">
				</a>
			</div>
			<!-- end partner -->
			...
			<div class="col-6 col-sm-4 col-lg-2">
				<a href="#" class="partner">
					<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/partners/activeden-light-background.png" alt="" class="partner__img">
				</a>
			</div>
			<!-- end partner -->
			...
			<div class="col-6 col-sm-4 col-lg-2">
				<a href="#" class="partner">
					<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/partners/3docean-light-background.png" alt="" class="partner__img">
				</a>
			</div>
			<!-- end partner -->
		</div>
