...
<!--                    <span class="db"> <img width="200px" src="admin/public/assets/images/logo_group5.png" alt="logo" /></span>-->
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    ...
                                    <a class="btn btn-success float-right" type="submit" href="signup.php">Register</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="recoverform">
                <div class="text-center">
                    <span class="text-white">Nhập địa chỉ e-mail của bạn vào bên dưới để khôi phục mật khẩu.</span>
                </div>
                <div class="row m-t-20">
                    <!-- Form -->
                    <form class="col-12" action="resetPass.php" method="POST">
                ...
                <div class="row m-t-20 p-t-20 border-top border-secondary">
                    <div class="col-12">
                        ...
                        <button class="btn btn-info float-right" type="submit" name="forgotpass">Recover</button>
                    </div>
                </div>
                </form>
            </div>
