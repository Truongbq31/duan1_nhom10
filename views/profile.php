					...
					<div class="profile__content">
						<div class="profile__user">
							<div class="profile__avatar">
								<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/user.svg" alt="">
							</div>
				...
				<div class="row row--grid">
					...
					<div class="col-12 col-sm-6 col-xl-3">
						<div class="stats">
							...
							<p>$19.99</p>
							<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/credit-card.svg" alt="">
						</div>
					</div>
					<!-- end stats -->
					...
					<div class="col-12 col-sm-6 col-xl-3">
						<div class="stats">
							...
							<p>1 172</p>
							<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/film.svg" alt="">
						</div>
					</div>
					<!-- end stats -->
					...
					<div class="col-12 col-sm-6 col-xl-3">
						<div class="stats">
							...
							<p>2 573</p>
							<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/comments.svg" alt="">
						</div>
					</div>
					<!-- end stats -->
					...
					<div class="col-12 col-sm-6 col-xl-3">
						<div class="stats">
							...
							<p>1 021</p>
							<img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/star-half-alt.svg" alt="">
						</div>
					</div>
					<!-- end stats -->
					...
					<div class="col-12 col-xl-6">
						<div class="dashbox">
							<div class="dashbox__title">
								<h3><img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/film.svg" alt=""> Movies for you</h3>
					...
					<div class="col-12 col-xl-6">
						<div class="dashbox">
							<div class="dashbox__title">
								<h3><img src="view/abc/dmitryvolkov.me/demo/flixgo2.0/main/img/star-half-alt.svg" alt=""> Latest reviews</h3>
