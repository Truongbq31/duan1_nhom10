            ...
            <div class="col-md-6">
                <div class="card">
                    <form method="POST" action="" enctype="multipart/form-data" class="form-horizontal">
                        <div class="card-body">
                            <h4 class="card-title">Sửa khung gio phòng chieu</h4>

                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Tên phòng</label>
                                <div class="col-sm-9">

                                    <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="id_phong_chieu">
                                        <option selected value="<?php echo $khungGioChieu_details->id_pc ?>"><?php echo $khungGioChieu_details->ten_phong ?></option>
                            ...
                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Gio bat đầu</label>
                                <div class="col-sm-9">

                                    <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="id_khung_gio_chieu">
                                        <option selected value="<?php echo $khungGioChieu_details->id_kgc ?>"><?php echo $khungGioChieu_details->gio_bat_dau ?></option>
